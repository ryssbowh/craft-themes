...
return [
	...
	"Allowed quantity" => "Allowed quantity",
	...
	"Cache depends on site" => "Cache depends on site",
	...
	"Cache duration (minutes)" => "Cache duration (minutes)",
	...
	"Disabling this will show all fields even if they don't have a value" => "Disabling this will show all fields even if they don't have a value",
	"Display" => "Display",
	"Display In stock/Out of stock" => "Display In stock/Out of stock",
	"Display email" => "Display email",
	"Display first name" => "Display first name",
	"Display full price" => "Display full price",
	"Display last name" => "Display last name",
	"Display photo" => "Display photo",
	"Display sale price" => "Display sale price",
	...
	"Error while fetching the theme's templates" => "Error while fetching the theme's templates",
	"Error while saving blocks" => "Error while saving blocks",
	"Error while saving view modes" => "Error while saving view modes",
	"Every available templates defined by the system for layouts/blocks/fields/files/groups/regions will be checked and their source will show as \"System\"." => "Every available templates defined by the system for layouts/blocks/fields/files/groups/regions will be checked and their source will show as \"System\".",
	...
	"Html tag" => "Html tag",
	"ICU date format, view documentation {tag}here{endtag}" => "ICU date format, view documentation {tag}here{endtag}",
	"Iframe" => "Iframe",
	"Image transform" => "Image transform",
	"In stock" => "In stock",
	"In stock label" => "In stock label",
	"Infinite" => "Infinite",
	"Install" => "Install",
	...
	"Maximum quantity label" => "Maximum quantity label",
	"Messages" => "Messages",
	"Minimum quantity" => "Minimum quantity",
	"Minimum quantity label" => "Minimum quantity label",
	...
	"Out of stock label" => "Out of stock label",
	...
	"Register" => "Register",
	"Reinstall themes layouts" => "Reinstall themes layouts",
	...
	"Show maximum quantity" => "Show maximum quantity",
	"Show minimum quantity" => "Show minimum quantity",
	...
	"Tablet" => "Tablet",
	"Tag : {name}" => "Tag : {name}",
	"Take the email itself if left blank" => "Take the email itself if left blank",
	"Template" => "Template",
	"Template Path" => "Template Path",
	"The folder containing themes, this is relative to the root folder" => "The folder containing themes, this is relative to the root folder",
	"The source will always be the theme where the template was defined first." => "The source will always be the theme where the template was defined first.",
	"Theme" => "Theme",
	"Themes" => "Themes",
	"Themes Development" => "Themes Development",
	"Themes block cache" => "Themes block cache",
	"Themes blocks" => "Themes blocks",
	"Themes data has been installed" => "Themes data has been installed",
	"Themes displayer cache" => "Themes displayer cache",
	...
	"This folder should be referenced in your composer config as a {tag}path repository{endtag}" => "This folder should be referenced in your composer config as a {tag}path repository{endtag}",
	"This group is empty" => "This group is empty",
	"This handle is already defined" => "This handle is already defined",
	"This is really not recommended, all your pages will display the same content" => "This is really not recommended, all your pages will display the same content",
	"This page will tell you which templates are overridden for each theme." => "This page will tell you which templates are overridden for each theme.",
	...
	"Transform" => "Transform",
	"Truncated" => "Truncated",
	"Truncating content will always strip Html tags" => "Truncating content will always strip Html tags",
	"Twig" => "Twig",
	"Twig Code" => "Twig Code",
	"Type" => "Type",
	"Type {type}" => "Type {type}",
	"Unit" => "Unit",
	"Unlimited" => "Unlimited",
	"Unlimited stock label" => "Unlimited stock label",
	"Url path" => "Url path",
	...
	"View mode" => "View mode",
	"View mode cannot be blank" => "View mode cannot be blank",
	...
	"View modes can't reference themselves" => "View modes can't reference themselves",
	"View port" => "View port",
