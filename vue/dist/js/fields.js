...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_array_iterator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/core-js/modules/es.array.iterator.js */ \"./node_modules/core-js/modules/es.array.iterator.js\");\n/* harmony import */ var _home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_array_iterator_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_array_iterator_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_promise_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/core-js/modules/es.promise.js */ \"./node_modules/core-js/modules/es.promise.js\");\n/* harmony import */ var _home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_promise_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_promise_js__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_object_assign_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/core-js/modules/es.object.assign.js */ \"./node_modules/core-js/modules/es.object.assign.js\");\n/* harmony import */ var _home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_object_assign_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_object_assign_js__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_promise_finally_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/core-js/modules/es.promise.finally.js */ \"./node_modules/core-js/modules/es.promise.finally.js\");\n/* harmony import */ var _home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_promise_finally_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_home_bobo_Web_docker_sites_craft35_plugins_craft_themes_node_modules_core_js_modules_es_promise_finally_js__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _main_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./main.scss */ \"./vue/src/fields/main.scss\");\n/* harmony import */ var _main_scss__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_main_scss__WEBPACK_IMPORTED_MODULE_4__);\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash */ \"./node_modules/lodash/lodash.js\");\n/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_5__);\n\n\n\n\n\n\ndocument.addEventListener(\"register-fields-components\", function (e) {\n  e.detail['matrix'] = {\n    component: {\n      props: {\n        item: Object\n      },\n      methods: {\n        updateMatrixItem: function updateMatrixItem(fieldId, typeId, data) {\n          for (var i in this.item.types) {\n            var type = this.item.types[i];\n\n            if (type.type.id != typeId) {\n              continue;\n            }\n\n            for (i in type.fields) {\n              var field = type.fields[i];\n\n              if (field.id != fieldId) {\n                continue;\n              }\n\n              field = Object(lodash__WEBPACK_IMPORTED_MODULE_5__[\"merge\"])(field, data);\n            }\n          }\n        }\n      },\n      emits: ['updateItem'],\n      template: \"\\n            <div>\\n                <field :item=\\\"item\\\" @updateItem=\\\"$emit('updateItem', $event)\\\"></field>\\n                <div class=\\\"matrix-type\\\" v-for=\\\"type, index in item.types\\\" v-bind:key=\\\"index\\\">\\n                    <div class=\\\"matrix-type-name\\\">{{ t('Type {type}', {type: type.type.name}) }}</div>\\n                    <draggable\\n                        item-key=\\\"id\\\"\\n                        :list=\\\"type.fields\\\"\\n                        group=\\\"'matrix-'+type.type_id\\\"\\n                        handle=\\\".move\\\"\\n                        >\\n                        <template #item=\\\"{element}\\\">\\n                            <field :item=\\\"element\\\" @updateItem=\\\"updateMatrixItem(element.id, type.type_id, $event)\\\"></field>\\n                        </template>\\n                    </draggable>\\n                </div>\\n            </div>\"\n    },\n    clone: function clone(oldDisplay, display) {\n      for (var i in display.item.types) {\n        for (var j in display.item.types[i].fields) {\n          display.item.types[i].fields[j].id = null;\n          display.item.types[i].fields[j].uid = null;\n        }\n      }\n    }\n  };\n  e.detail['table'] = {\n    component: {\n      props: {\n        item: Object\n      },\n      methods: {\n        updateTableItem: function updateTableItem(key, data) {\n          var item = this.item.fields[key];\n          item = Object(lodash__WEBPACK_IMPORTED_MODULE_5__[\"merge\"])(item, data);\n        }\n      },\n      emits: ['updateItem'],\n      template: \"\\n            <div>\\n                <field :item=\\\"item\\\" @updateItem=\\\"$emit('updateItem', $event)\\\"></field>\\n                <div class=\\\"table-type\\\">\\n                    <field :item=\\\"element\\\" v-for=\\\"element, key in item.fields\\\" :moveable=\\\"false\\\" v-bind:key=\\\"key\\\" @updateItem=\\\"updateTableItem(key, $event)\\\"></field>\\n                </div>\\n            </div>\"\n    },\n    clone: function clone(oldDisplay, display) {}\n  };\n});\n\n//# sourceURL=webpack:///./vue/src/fields/main.js?");
